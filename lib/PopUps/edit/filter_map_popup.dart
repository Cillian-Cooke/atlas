...
class FilterMapPopUpContent extends StatefulWidget {
  final String description;

  const FilterMapPopUpContent({
    super.key,
    required this.description,
  });

  @override
  State<FilterMapPopUpContent> createState() => _FilterMapPopUpContentState();
}

class _FilterMapPopUpContentState extends State<FilterMapPopUpContent> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Optionally: show buttons, apply FilterMaps, etc.
          ElevatedButton(
            onPressed: () {
...
Future<void> showFilterMapPopUp(BuildContext context, String description) {
  return showDialog(
    context: context,
    ...
    builder: (context) {
      return PopupContainer(
        child: FilterMapPopUpContent(description: description),
      );
    },
  );
}
